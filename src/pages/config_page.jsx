...
const ConfigPage = () => {
  ...
  /*
  const{aConfig, getParametros, setParametros } = useContext(ConfigContext);
  const aValores = [];
  ...
  const handleSubmit = (evento) => {
    ...
    console.log("El formulario se actualizo");
  };

  const handleNombreInput = (evento) => {
    aValores.nombre, nombre:evento.target.value} );
  };

  const handleCorreoInput = (evento) => {
    setDatosForm( {...datosForm, correo:evento.target.value} );
  };

  const handleDireccionTextarea = (evento) => {
    setDatosForm( {...datosForm, mensaje:evento.target.value} );
  };

  const handleTelefonoTextarea = (evento) => {
    setDatosForm( {...datosForm, mensaje:evento.target.value} );
  };
            ...
            <div className="lg:w-1/2 md:w-2/3 mx-auto">
              <div className="flex flex-wrap -m-2">
                ...
                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  <a className="text-indigo-500">comedor@comedor.com</a>
